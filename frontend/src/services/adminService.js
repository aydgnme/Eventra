...
/** Get validation stats (pending count, approved/rejected today) */
export const getEventStats = () => api.get('/admin/events/stats').then(r => r.data)

/** Get all events filterable by status: 'pending' | 'approved' | 'rejected' */
export const getAllEvents = (params) => api.get('/admin/events/all', { params }).then(r => r.data)
...
const adminService = {
  ...
  getPendingEvents, getEventStats, getAllEvents, validateEvent, rejectEvent, publishEvent, unpublishEvent,
  getAuditLogs,
