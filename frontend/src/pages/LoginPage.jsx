        ...
        <div className="relative z-10 space-y-6">
          <div className="space-y-3">
            ...
            <h1 className="text-4xl font-bold text-white leading-tight">
              Orchestrate Impactful
              <br />
              <span className="text-usv-blue">Campus Experiences.</span>
            </h1>
            <p className="text-white/70 text-lg leading-relaxed max-w-sm">
              The definitive platform for USV event management, registration tracking, and attendee engagement.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                ...
                <Link to="/forgot-password" className="text-xs text-link hover:text-brand-500 transition-colors">
                  Forgot password?
                </Link>
              </div>
